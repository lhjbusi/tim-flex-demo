    ...
    public class SpeakerInit extends Object
    {
        ...
        public function avStatus()
        {
            setTimeout(function ()
            {
                ...
                WebUtil.info("设备检测结果，Mic ActiveLevel：" + _loc_1 + "，Camera ActiveLevel：" + _loc_2);
                _loc_1 = _loc_1 > 0 && _loc_1 < 100 ? (1) : (0);
                _loc_2 = _loc_2 > 0 && _loc_2 < 100 ? (1) : (0);
                WebUtil.info("设备检测结果，al：" + _loc_1 + "，vl：" + _loc_2);
        ...
        private function audioStop(param1 = "1", param2:Boolean = false) : void
        {
            ...
            {
                WebUtil.info("主动停止接收用户语音异常(" + e + ")");
            }
            WebUtil.info("主动停止接收用户语音完成(" + uid + ")");
            return;
        }// end function
        ...
        private function clearLine(param1 = "1")
        {
            ...
            {
                WebUtil.info("主动清除连接 clearLine");
            }
            WebUtil.info("主动清除连接 clearLine完成");
            return;
        }// end function
        ...
        private function clearNet(param1 = "1")
        {
            ...
            WebHelp.nd("关闭连接、" + new Date().getUTCDate());
            return;
        }// end function
