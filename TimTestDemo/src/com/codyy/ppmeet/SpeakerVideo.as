package com.codyy.ppmeet
{
    ...
    public class SpeakerVideo extends MovieClip
    {
        ...
        public function initServer()
        {
            ...
            WebUtil.info("企业码：" + Constans.E_CODE);
            WebUtil.info("RTMFP运行环境：" + Constans.RTMFP_SERVER + " --- " + Constans.RTMFP_DEVKEY);
            WebUtil.info("Red5运行环境：" + Constans.RTMP_SERVER + " --- " + Constans.RTMP_USER);
            WebUtil.info("多路语音通讯P2P运行环境：" + (Constans.P2P ? ("P2P") : ("Red5")));
            WebUtil.info("流量统计开关：" + Constans.NETWORD_TRAFFIC);
            WebUtil.info("Debug 环境：Debug ：" + Constans.DEBUG + " --- File Debug ：" + Constans.FILE_DEBUG);
            ...
            WebUtil.info("会议类型 ： " + (Constans.MEET_TYPE == 1 ? ("语音会议") : ("视频会议")));
            WebUtil.info("会议模式 ： " + (Constans.MEET_MODEL == 1 ? ("普通模式") : ("直播模式")));
