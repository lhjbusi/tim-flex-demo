package com.codyy.ppmeet.p2p
{
    ...
    public class P2pLargeVideo extends Sprite
    {
        ...
        private function initRTMFP()
        {
            ...
            WebHelp.nd("初始化主讲人视频：" + (this.sv.getParam("rtmfp") || this.SERVER + this.DEVKEY));
        ...
        private function onNetStatus(event:NetStatusEvent) : void
        {
            switch(event.info.code)
            {
                ...
                {
                    WebHelp.nd("初始化主讲人视频成功！");
                    this._netConnectionConnected = true;
                    WebUtil.sendMsg({act:"sys", say:"获取身份标识号成功！"});
                ...
                case "NetConnection.Connect.InvalidApp":
                {
                    ...
                    WebHelp.nd("主讲人视频连接失败！使用NetGroup连接！");
                    WebUtil.sendMsg({act:"sys", say:"连接服务器失败：" + event.info.code});
                    if (this._netGroup)
                    {
                        this.clearNetGroup();
                    }
                ...
                {
                    WebHelp.nd("主讲人视频NetGroup成功");
                    this._netGroupConnected = true;
                    WebUtil.sendMsg({act:"sys", say:"你已加入会议组" + this.getKey()});
        ...
        private function _startp2ppublish()
        {
            ...
            WebHelp.nd("主讲人发布视频完成：" + this.getKey() + "_video");
