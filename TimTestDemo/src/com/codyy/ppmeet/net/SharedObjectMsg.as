package com.codyy.ppmeet.net
{
    ...
    public class SharedObjectMsg extends Object
    {
        ...
        public function netStatusHandler(event:NetStatusEvent) : void
        {
            ...
            {
                WebHelp.info("初始化文本聊天房间：" + Constans.E_CODE + "pchat_" + this.sv.getParam("meetId"));
        ...
        public function callPage(param1:String)
        {
            WebHelp.callJS("flash_call", param1);
            return;
        }// end function

        public function showTime(param1:String)
        {
                ...
                if (_loc_4.name != undefined)
                {
                    switch(_loc_4.name)
                    {
                        case "text_message":
                        {
                            ...
                            {
                                WebHelp.info("收到房间消息(" + _loc_5.uid + ")：" + _loc_5.msg + "---" + _loc_5.rtime);
                                if (_loc_5.rtime > 0)
                                {
        ...
        public function saveMsg(param1:String)
        {
